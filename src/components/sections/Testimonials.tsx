      ...
      <div className="wrapper relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 grid-no-collapse">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="group relative rounded-none border border-border bg-surface p-8 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:border-accent hover:shadow-none"
            >
              {/* Rating */}
