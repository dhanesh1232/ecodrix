    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(124,110,250,0.06) 0%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
      </div>
      ...
      <div className="relative z-10">
        <p
          className="font-display font-black grad-text mb-4"
          style={{ fontSize: "clamp(5rem, 15vw, 10rem)", lineHeight: 1 }}
        >
          404
        </p>
        <h1 className="font-display font-bold text-white text-2xl md:text-3xl mb-3 tracking-tight">
          Page not found
        </h1>
